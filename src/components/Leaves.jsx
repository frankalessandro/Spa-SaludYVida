...
export const LeavesAnimate = () => {
  ...
  return (
    <div 
      ref={ref}
      className="absolute right-[-50px] opacity-40 md:right-0 bottom-[-10vh] md:bottom-[-20vh] z-[0] w-[40vw] md:w-[20vw] md:h-[30vh]"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 1000 500"
        fill="#167364"
        className={`w-full h-full ${inView ? 'animate-slide-in-bottom-left' : 'opacity-0 transform translate-x-[-100%] translate-y-[100%] rotate-[75deg]'}`}
      >
