...
const timelineItems = [
  ...
  },
  {
    ...
    features: [
      "Duración: 60-90 minutos por zona",
      "Tecnología de enfriamiento avanzado",
      "Proceso cómodo y sin anestesia"
    ],
    icon: Star,
    benefits: [
      "Sin tiempo de recuperación",
      "Reducción de grasa de forma natural",
  ...
  },
  {
    ...
    features: [
      "Reducción de grasa efectiva",
      "Mejora en la firmeza y apariencia de la piel",
...
const textImages = [
  '❄️ Técnica no invasiva con tecnología de enfriamiento controlado',
  '🔬 Reducción de grasa de forma natural y segura',
  '💎 Modelado del contorno corporal sin cirugía',
  '🌟 Piel más tonificada y contorno definido'
];
...
export const Criolipolisis = () => {
  ...
  const whyChooseUs = [
    {
      title: "Escultura Corporal Natural",
      description: "Nuestros tratamientos de Criolipólisis ayudan a esculpir y definir el contorno corporal de manera natural, reduciendo la grasa localizada.",
    },
    {
      title: "Tecnología No Invasiva",
      description: "La Criolipólisis es un procedimiento seguro y sin cirugía que actúa de forma precisa para eliminar grasa sin dañar los tejidos circundantes.",
    },
    {
      title: "Resultados Visibles y Duraderos",
      description: "Cada sesión de Criolipólisis ofrece resultados progresivos que se mantienen a largo plazo, mejorando la forma de tu cuerpo de manera natural.",
    },
    {
      title: "Bienestar Integral",
      description: "Disfruta de un entorno relajante y profesional que prioriza tu comodidad y optimiza tu experiencia durante el tratamiento.",
    },
  ];
      ...
      <div className="h-screen max-h-screen bg-[#160520] max-w-[100vw] md:min-w-[100vw] overflow-x-hidden">
              ...
              <div className="container mx-auto px-4">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 w-full">
                  ...
                  >
                    ...
                    {/* Criolipólisis (Siempre centrado) */}
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl gold-text tracking-tighter p-2">
                      Reducción Natural de Grasa
                    </h1>
                    <div className="w-24 h-0.5 bg-gray-600" />
                    <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 font-light">
                      Reduce la grasa localizada y esculpe tu cuerpo de manera no invasiva con nuestro tratamiento de criolipólisis.
                    </p>
                    <motion.button
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h1 className="text-3xl md:text-4xl lg:text-7xl font-bold text-black mb-4 rounded-full titles-font-family">
              Criolipólisis: Reducción de Grasa de Forma Natural.
            </h1>
        ...
        <section className="bg-[#160520] ">
          ...
          <ResultsTimeline
            ...
            title="Proceso de Escultura Corporal con Criolipólisis"
            description="Reducción de grasa y tonificación de la piel con tratamientos avanzados y no invasivos"
            className="z-20"
          />
        </section>
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-16">
              ...
              <motion.p
                ...
                variants={fadeInUp}
              >
                Redescubre la vitalidad de tu piel con nuestros exclusivos tratamientos de microneedling, diseñados para estimular la regeneración natural y mejorar la textura de forma no invasiva.
              </motion.p>
            </div>
