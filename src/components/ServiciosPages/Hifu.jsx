      ...
      <div className="min-h-screen absolute bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 top-[-70px] z-0">
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            <motion.button
              className="mt-8 px-8 py-4 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full text-white font-semibold text-lg hover:shadow-lg hover:shadow-pink-500/50 transition-all"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
