...
export const Plasma = () => {
  ...
  // lista de razones para elegir nuestro servicio de PLASMA
  const whyChooseUs = [
            ...
            <div className="w-full mt-20 md:mt-0 lg:w-[40vw] flex flex-col justify-center space-y-6 lg:space-y-8 z-10 mb-8 lg:mb-0">
              <div className="text-black">
                <h1 className="text-4xl md:text-5xl lg:text-8xl font-bold mb-4 leading-tight p-2">
                  <span className="vertical-gradient-text block">PLASMA</span>
                  <span className="block">
                    <span className="vertical-gradient-text">Regeneración</span>
                    <span className="text-purple-400"> Celular</span>
                  </span>
                </h1>
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              PLASMA es un tratamiento no invasivo que utiliza plasma extraído del propio paciente para ser inyectado en la piel, estimulando la regeneración celular y la producción de colágeno y elastina. Este procedimiento natural mejora la textura, firmeza y luminosidad de la piel, promoviendo un aspecto rejuvenecido sin necesidad de cirugía.
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8 relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              <img
                src={img1}
                alt="Tratamiento facial con plasma"
                className="rounded-lg shadow-lg"
              />
              <img
                src={img1}
                alt="Proceso de aplicación de plasma"
                className="rounded-lg shadow-lg"
              />
              <img
                src={img1}
                alt="Resultados del tratamiento con plasma"
